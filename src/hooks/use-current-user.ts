  ...
  return useQuery<CurrentUser | null>({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        onboardingGateBlocked: false,
        onboardingAnyRejected: false,
        onboardingAnySubmitted: false,
        onboardingAnyDraft: false,
        viewingAs: false,
        realIsSuperAdmin: true,
        realIsHrAdmin: true,
      };
