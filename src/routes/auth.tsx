      ...
      <div className="flex items-center justify-center p-6">
        <Card className="w-full max-w-md shadow-elevated">
          <CardHeader>
            ...
            <CardDescription>Sign in with the account your admin registered for you.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="rounded-lg border border-border bg-muted/40 p-3 text-sm">
              Accounts are invite-only. If your account hasn't been registered yet, please contact your administrator.
            </div>
            <Button variant="outline" className="w-full" onClick={handleGoogle} disabled={loading || pwLoading}>
            ...
            <form onSubmit={handlePassword} className="space-y-3">
              ...
              <Button type="submit" className="w-full" disabled={pwLoading || loading}>
