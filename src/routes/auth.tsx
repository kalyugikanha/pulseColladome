...
function AuthPage() {
  ...
  async function handleGoogle() {
    ...
    if (result.error) { toast.error(result.error.message || "Pulse Google sign-in failed"); setLoading(false); return; }
        ...
        <Card className="w-full max-w-md shadow-elevated">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              This signs you into Pulse. Google Calendar sync is connected separately from the Team Calendar page.
            </p>
