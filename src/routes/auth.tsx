...
export const Route = createFileRoute("/auth")({
  beforeLoad: async () => {
    // DEV BYPASS: Commented out original check to allow AuthPage to load
...
function AuthPage() {
  ...
  // DEV BYPASS: Auto-navigate to dashboard on mount
  useEffect(() => {
      ...
      <div className="flex items-center justify-center p-6">
        <Card className="w-full max-w-md shadow-elevated">
          <CardHeader>
            ...
            <CardDescription>Google sign-in only — use your Colladome Google account.</CardDescription>
          </CardHeader>
