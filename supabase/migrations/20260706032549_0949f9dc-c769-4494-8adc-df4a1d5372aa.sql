...
-- New users default to not onboarded
ALTER TABLE public.profiles ALTER COLUMN onboarding_completed SET DEFAULT false;

-- Update handle_new_user to explicitly set onboarding_completed = false for new signups
...
BEGIN
  ...
  INSERT INTO public.profiles (id, full_name, email, avatar_url, must_change_password, onboarding_completed)
  VALUES (
    NEW.id,
